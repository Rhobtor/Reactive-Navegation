...
#ifndef CAR_CPP__SRV__DETAIL__SET_BIAS__FUNCTIONS_H_
#define CAR_CPP__SRV__DETAIL__SET_BIAS__FUNCTIONS_H_
...
#include "car_cpp/srv/detail/set_bias__struct.h"
 ...
 * calls
 * car_cpp__srv__SetBias_Request__init().
...
/**
 * It calls
 * car_cpp__srv__SetBias_Request__fini()
 ...
 * car_cpp__srv__SetBias_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * car_cpp__srv__SetBias_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * car_cpp__srv__SetBias_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_car_cpp
...
/**
 * It calls
 * car_cpp__srv__SetBias_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_car_cpp
...
/**
 * It allocates the memory for the array and calls
 * car_cpp__srv__SetBias_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_car_cpp
...
/**
 * It calls
 * car_cpp__srv__SetBias_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CAR_CPP__SRV__DETAIL__SET_BIAS__FUNCTIONS_H_
