...
{
  new (message_memory) car_interfaces::msg::Graph(_init);
}

void Graph_fini_function(void * message_memory)
{
  auto typed_message = static_cast<car_interfaces::msg::Graph *>(message_memory);
  typed_message->~Graph();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Graph_message_member_array[2] = {
  {
    ...
    offsetof(car_interfaces::msg::Graph, nodes),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(car_interfaces::msg::Graph, edges),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Graph_message_members = {
  ...
  "Graph",  // message name
  2,  // number of fields
  sizeof(car_interfaces::msg::Graph),
...
{
  return &::car_interfaces::msg::rosidl_typesupport_introspection_cpp::Graph_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, car_interfaces, msg, Graph)() {
  return &::car_interfaces::msg::rosidl_typesupport_introspection_cpp::Graph_message_type_support_handle;
}
