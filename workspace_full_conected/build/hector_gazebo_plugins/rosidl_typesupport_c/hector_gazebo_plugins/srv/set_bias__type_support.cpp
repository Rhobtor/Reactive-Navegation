...
static const _SetBias_Request_type_support_symbol_names_t _SetBias_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hector_gazebo_plugins, srv, SetBias_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hector_gazebo_plugins, srv, SetBias_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hector_gazebo_plugins, srv, SetBias_Request)() {
  return &::hector_gazebo_plugins::srv::rosidl_typesupport_c::SetBias_Request_message_type_support_handle;
}
...
static const _SetBias_Response_type_support_symbol_names_t _SetBias_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hector_gazebo_plugins, srv, SetBias_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hector_gazebo_plugins, srv, SetBias_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hector_gazebo_plugins, srv, SetBias_Response)() {
  return &::hector_gazebo_plugins::srv::rosidl_typesupport_c::SetBias_Response_message_type_support_handle;
}
...
static const _SetBias_type_support_symbol_names_t _SetBias_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hector_gazebo_plugins, srv, SetBias)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hector_gazebo_plugins, srv, SetBias)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, hector_gazebo_plugins, srv, SetBias)() {
  return &::hector_gazebo_plugins::srv::rosidl_typesupport_c::SetBias_service_type_support_handle;
}
