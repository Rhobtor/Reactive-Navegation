...
#ifndef HECTOR_GAZEBO_PLUGINS__SRV__DETAIL__SET_REFERENCE_GEO_POSE__FUNCTIONS_H_
#define HECTOR_GAZEBO_PLUGINS__SRV__DETAIL__SET_REFERENCE_GEO_POSE__FUNCTIONS_H_
 ...
 * calls
 * hector_gazebo_plugins__srv__SetReferenceGeoPose_Request__init().
...
/**
 * It calls
 * hector_gazebo_plugins__srv__SetReferenceGeoPose_Request__fini()
 ...
 * hector_gazebo_plugins__srv__SetReferenceGeoPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * hector_gazebo_plugins__srv__SetReferenceGeoPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hector_gazebo_plugins__srv__SetReferenceGeoPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hector_gazebo_plugins
...
/**
 * It calls
 * hector_gazebo_plugins__srv__SetReferenceGeoPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hector_gazebo_plugins
...
/**
 * It allocates the memory for the array and calls
 * hector_gazebo_plugins__srv__SetReferenceGeoPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hector_gazebo_plugins
...
/**
 * It calls
 * hector_gazebo_plugins__srv__SetReferenceGeoPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HECTOR_GAZEBO_PLUGINS__SRV__DETAIL__SET_REFERENCE_GEO_POSE__FUNCTIONS_H_
